...
class AddRecordForm(forms.ModelForm):
    first_name = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"姓氏", "class":"form-control"}), label="")
    last_name = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"名字", "class":"form-control"}), label="")
    ...
    state = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"地區", "class":"form-control"}), label="")
